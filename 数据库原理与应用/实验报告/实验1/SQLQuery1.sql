...
insert into Student values('20125122','刘晨','女','19','CS');
insert into Student values('20125123','王敏','女','18','MA');
insert into Student values('20125125','张立','男','19','IS');
...
use SPJ_Database
 ...
 use SPJ_Database
alter table S
	alter column SNO varchar(16)
alter table P
	alter column PNO varchar(16)
alter table SPJ
	alter column SNO varchar(16)
	alter column PNO varchar(16)
	alter column JNO varchar(16)
